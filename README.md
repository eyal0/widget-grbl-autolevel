...
| chilipeppr.load() URL | http://raw.githubusercontent.com/eyal0/widget-grbl-autolevel/master/auto-generated-widget.html |
| Edit URL              | http://ide.c9.io/eyal0/widget-grbl-autolevel |
| Github URL            | http://github.com/eyal0/widget-grbl-autolevel |
| Test URL              | https://preview.c9users.io/eyal0/widget-grbl-autolevel/widget.html |
...
To better understand how ChiliPeppr's publish() method works see amplify.js's documentation at http://amplifyjs.com/api/pubsub/
  ...
  <table id="com-chilipeppr-elem-pubsubviewer-foreignsub" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>/com-chilipeppr-widget-autolevel/com-chilipeppr-widget-3dviewer/recv3dObject</td><td>When we request a /com-chilipeppr-widget-3dviewer/request3dObject we get back this signal and the payload is the actual user object so we can analyze it.</td></tr><tr valign="top"><td>/com-chilipeppr-widget-autolevel/com-chilipeppr-interface-cnccontroller/proberesponse</td><td>we receive the parsed probe trigger coordinates back from the cnc interface.</td></tr>    
      </tbody>
  </table>
